...
@Service
//@RequiredArgsConstructor    // lombok magic, does the same that all the @autowired code does!
public class TeacherService implements ITeacherService{
    ...
    @Autowired
    public TeacherService(TeacherRepository teacherRepository, RegionRepository repository, Mapper mapper) {
